...
const BlogList = () => {
  ...
  return (
    <div>
        ...
        {blogCategories.map((item) => (
          <div key={item} className='relative'>
            ...
            <button onClick={() => setMenu(item)}
              ...
              {/* If menu === item is true, then the expression evaluates to 'text-white px-4 pt-0.5' */}
      ...
      <div>
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-8 mb-24 mx-8 sm:mx-16 xl:mx-4'>
